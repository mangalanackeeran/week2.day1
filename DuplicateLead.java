...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		elementDuplicateCompanyName.sendKeys("newcompany");
		
		WebElement elementDuplicateFirstName = driver.findElement(By.id("createLeadForm_firstName"));
		elementDuplicateFirstName.clear();
		elementDuplicateFirstName.sendKeys("NewFirstName");
		
		
		WebElement elementDuplicatecreateButton = driver.findElement(By.className("smallSubmit"));
		elementDuplicatecreateButton.click();
